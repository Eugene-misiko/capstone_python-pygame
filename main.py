...
RED = (255, 0, 0)
YELLOW = (255, 255, 0)
BOARDER = pygame.Rect(900//2 - 5, 0, 10, 500)
...
def yellow_handle_movement(keys_pressed,yellow):
    if keys_pressed[pygame.K_a] and yellow.x - VEL > 0:#key left
        yellow.x -= VEL
    if keys_pressed[pygame.K_d] and yellow.x + VEL + yellow.width < BOARDER.x :#key right
        yellow.x += VEL
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0:#key up
        yellow.y -= VEL
    if keys_pressed[pygame.K_s] and yellow.y + VEL + yellow.height < 500 - 15:#key down
        yellow.y += VEL

def red_handle_movement(keys_pressed,red):
    if keys_pressed[pygame.K_LEFT] and red.x - VEL > BOARDER.x + BOARDER.width:#key left
        red.x -= VEL
    if keys_pressed[pygame.K_RIGHT] and red.x + VEL + red.width < 900:#key right
        red.x += VEL
    if keys_pressed[pygame.K_UP] and red.y - VEL > 0:#key up
        red.y -= VEL
    if keys_pressed[pygame.K_DOWN] and red.y + VEL + red.height < 500 - 15:#key down
        red.y += VEL        
